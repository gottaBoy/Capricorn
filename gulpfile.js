...
gulp.task('copy', function() {
    ...
    gulp.src(['bower_components/jQuery.mmenu/dist/css/*', 'bower_components/jQuery.mmenu/dist/js/*'])
        .pipe(gulp.dest('vendor/jquery.mmenu/'))

    gulp.src(['bower_components/site/**'])
        .pipe(gulp.dest('vendor/site/'))

    gulp.src(['bower_components/h5bp/**'])
        .pipe(gulp.dest('vendor/h5bp/'))
...
gulp.task('dev', ['browserSync', 'less', 'sass','minify-css', 'js', 'minify-js'], function() {
